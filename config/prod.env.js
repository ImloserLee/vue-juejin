...
module.exports = {
  NODE_ENV: '"production"',
  API_TIMElINE: '"https://timeline-merger-ms.juejin.im/v1"',
  API_AUTH: '"https://juejin.im/auth/type/phoneNumber"',
  API_USERINFO: '"https://user-storage-api-ms.juejin.im/v1"',
  API_BROCHURE: '"https://xiaoce-timeline-api-ms.juejin.im/v1"',
